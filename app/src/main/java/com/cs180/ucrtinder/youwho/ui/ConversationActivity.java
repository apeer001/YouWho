...
import com.cs180.ucrtinder.youwho.Messenger.AtlasQRCaptureScreen;
...
import com.cs180.ucrtinder.youwho.atlas.AtlasConversationsList;
...
public class ConversationActivity extends AppCompatActivity {
    ...
    private void route() {
        ...
        if (app.getLayerClient() == null && app.getLayerClient() == null) {
