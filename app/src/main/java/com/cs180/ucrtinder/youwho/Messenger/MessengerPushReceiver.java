...
public class MessengerPushReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if (debug) Log.w(TAG, "onReceive() action: " + intent.getAction() + ", extras: " + YouWhoApplication.toString(intent.getExtras(), "\n", "\n"));
    ...
    private String getTitle(Context context, final Uri conversationId) {
        ...
        if (!(appContext instanceof YouWhoApplication)) return null;

        YouWhoApplication app = (YouWhoApplication)appContext;
